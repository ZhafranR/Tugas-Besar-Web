...
<html lang="en">
  <head>
    ...
    <title>Daftar Kelas RuangZenius</title>
  </head>
  <body>
    <!-- navbar -->
    <nav class="navbar">
      ...
      <div class="container">
        <div class="row my-5">
          <div class="col-12">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="daftarKelas.html">Daftar Kelas</a></li>
        ...
        <div class="row responsive-card  justify-content-center">
          <div class=" mx-auto mb-5">
            <div class="card custom-card" style="width: 24rem">
              ...
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary custom-button my-2"
                  >Ikuti Kelas</a
                >
              </div>
            </div>
          ...
          <div class=" mx-auto mb-5">
            <div class="card custom-card" style="width: 24rem">
              <img
                src="assets/img/codeigniter.jpg"
                class="card-img-top"
                alt=""
              />
              <div class="card-body">
