<?php
    ...
    $jenislangganan = query("SELECT *FROM jenisLangganan WHERE jenis='Premium'");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
.basic-border {
  background-color: rgba(250, 73, 93, 0.24);
  color: #fb4b5d;
  font-size: 18px;
  line-height: 27px;
  text-align: left;
     ...
     <nav class="navbar">
      ...
      <div class="container mt-4">
        <div class="row" style="align-content: space-between; gap: 48px;">
            <div class="parent">
                <div class="card">
                    <div id="basic" class="col colborder">
                        <h2 class="basic-header">PREMIUM</h2>
                        <h1 class="basic-price">Rp 1.000.000,-</h1>
                        <div class="basic-border">
                          <p class="basic-text">Masa Berlangganan<br>12 Bulan</p>
          ...
          <p class="f-dateakhir" name="dateend"><?php
            $tgl =  date('Y/m/d');
            $dateselesai = manipulasiTanggal($tgl,'12','months');
            echo $dateselesai;?></p>
          </div>
                      <button class="button">
      ...
      <script>
        ...
        function pembayaran(){
          ...
          $jenisbasic = 'Premium';
          $dateawal =  date('Y/m/d');
          $dateselesai = manipulasiTanggal($dateawal,'12','months');
        ...
        function getCookie(){
          ...
          document.cookie = `${email}-${password}-${'Rp 1,000,000'}`;
