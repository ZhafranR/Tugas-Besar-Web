...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style_pembayaran_berhasil.css" />
            ...
            <div class="home">
                ...
                <div class="row" style="align-content: space-between; gap: 48px;">
                    <div class="img-loading">
                        <center><img src="assets/img/pembayaranBerhasil.png" alt="payment-loading" /></center>
                    </div>
                </div>
                <div class="desc">
                    <center>
                        <p>Selamat! Kamu berhasil berlangganan di RuangZenius. <br>
